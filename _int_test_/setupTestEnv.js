...
const createTableSQL = "CREATE TABLE IF NOT EXISTS products (id SERIAL, product text, color text, price integer, status boolean, gross_amount numeric, net_amount numeric, excluded_vat_amount numeric, PRIMARY KEY(id))";
...
module.exports = function setupTestEnv(){
    ...
    beforeEach(async () =>{
        await app.pg.query(createTableSQL)
        await app.pg.query(insertFakeProductSQL, ["Test Product", "Test Color", 2, true, 20, 16.67, 3.33]);
    })
